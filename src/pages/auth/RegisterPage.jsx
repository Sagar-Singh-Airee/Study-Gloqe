                ...
                >
                    ...
                    <div className="card">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="text-primary-300">Start your premium learning journey</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <User className="absolute left-5 top-1/2 -translate-y-1/2 text-primary-400" size={20} />
                                    <input
                                        type="text"
                                        name="name"
                                        value={formData.name}
                            ...
                            {/* Terms */}
                            <div className="text-sm text-primary-300 text-center">
